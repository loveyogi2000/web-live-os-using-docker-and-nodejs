...
class ImageAddon {
    constructor(workerPath, opts) {
        ...
        this._workerManager = new WorkerManager_1.WorkerManager(workerPath, this._opts);
    ...
    activate(terminal) {
        ...
        if (this._opts.sixelSupport) {
            const sixelHandler = new SixelHandler_1.SixelHandler(this._opts, this._storage, terminal, this._workerManager);
    ...
    _xtermGraphicsAttributes(params) {
        ...
        if (params[0] === 2 /* GaItem.SIXEL_GEO */) {
            switch (params[1]) {
                ...
                case 1 /* GaAction.READ */:
                    let width = (_b = (_a = this._renderer) === null || _a === void 0 ? void 0 : _a.dimensions) === null || _b === void 0 ? void 0 : _b.canvasWidth;
                    let height = (_d = (_c = this._renderer) === null || _c === void 0 ? void 0 : _c.dimensions) === null || _d === void 0 ? void 0 : _d.canvasHeight;
                    if (!width || !height) {
